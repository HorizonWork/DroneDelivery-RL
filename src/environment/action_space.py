...
class ActionSpace:
    ...
    def apply_safety_constraints(
        ...
        """
        # ✅ FIX: ALWAYS clip first, even if safety_limits disabled
    ...
    def _apply_contextual_constraints(
        ...
        if current_altitude < 1.0 and constrained_action[2] > 0:  # Too low and descending (NED)
    ...
    def validate_action(self, action: np.ndarray) -> bool:
        ...
        # ✅ FIX: Warn but don't reject out-of-bounds (will be clipped)
        tolerance = 0.1
