...
class SensorInterface:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.logger.info(
            f"Frequencies - Camera: {self.camera_frequency}Hz, "
    ...
    def get_statistics(self) - Dict[str, Any]:
        ...
        if self.processing_times:
            stats["processing_performance"] = {
                ...
                "processing_frequency": (
                    1.0 / np.mean(self.processing_times)
        ...
        if self.data_history:
            recent_quality = [
                data.data_quality for data in list(self.data_history)[-50:]
            ]
            stats["data_quality"] = {
    ...
    def get_sensor_health(self) - Dict[str, str]:
        ...
        if self.latest_data:
            if (
                self.latest_data.stereo_left is not None
                and self.latest_data.stereo_right is not None
            ):
