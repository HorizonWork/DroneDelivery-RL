            ...
            for obstacle in obstacles:
                ...
                if obs_type == "box":
                    ...
                    obs_circle = patches.Circle(
                        (x, y), radius, facecolor=self.colors["obstacle"], alpha=0.7
                    )
...
class TrajectoryPlotter:
    ...
    def plot_trajectory_analysis(
        ...
        axes[0, 0].plot(
            time_axis, trajectory[:, 1], label="Y", color=self.trajectory_colors[1]
        )
        axes[0, 0].plot(
            time_axis, trajectory[:, 2], label="Z", color=self.trajectory_colors[2]
        )
