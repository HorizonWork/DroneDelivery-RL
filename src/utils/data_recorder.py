...
class DataRecorder:
    ...
    def stop_recording(self) -> str:
        ...
        self.logger.info(
            f"Recorded {len(self.flight_data_buffer)} flight samples, "
                    ...
                    writer.writerow(
                        {
                            ...
                            "vel_x": record.velocity[0],
                            "vel_y": record.velocity[1],
                            "vel_z": record.velocity[2],
                            "quat_x": record.orientation[0],
                            "quat_y": record.orientation[1],
                            "quat_z": record.orientation[2],
                            "quat_w": record.orientation[3],
                            "ang_vel_x": record.angular_velocity[0],
                            "ang_vel_y": record.angular_velocity[1],
                            "ang_vel_z": record.angular_velocity[2],
                            "action_vx": record.action[0],
                            "action_vy": record.action[1],
                            "action_vz": record.action[2],
                            "action_yaw_rate": record.action[3],
    ...
    def record_episode(self, data: dict):
        ...
        try:
            ...
            episode_data = {
                ...
                "distance_to_goal": data.get("distance_to_goal", 0.0),
