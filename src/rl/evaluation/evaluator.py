...
class DroneEvaluator:
    ...
    def generate_evaluation_report(self) -> str:
        ...
        if "path_efficiency" in trajectory_analysis:
            ...
            report_lines.append(
                f"Average smoothness score: {trajectory_analysis.get('smoothness_score', 0):.3f}"
            )
            report_lines.append("")
        ...
        if self.episode_results:
            ...
            if successful_episodes:
                ...
                report_lines.append(
                    f"Average replans per successful episode: {avg_replans:.1f}"
                )
        ...
        stats = {
            "episode_statistics": {
                ...
                "successful_episodes": len(
                    [r for r in self.episode_results if r.success]
                ),
                "failed_episodes": len(
