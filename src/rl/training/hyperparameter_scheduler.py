...
class HyperparameterScheduler:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.adaptation_window = config.get('adaptation_window', 1000)      # Steps for adaptation
    ...
    def _adaptive_adjustment(self, schedule: HyperparameterSchedule) -> float:
        ...
        recent_performance = self.performance_history[schedule.adaptation_metric][-10:]  # Last 10 values
