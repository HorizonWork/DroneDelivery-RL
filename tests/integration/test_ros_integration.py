...
class TestROSIntegration:
    ...
    def test_ros_service_call(self):
        ...
        try:
            ...
            service_list = rospy.get_service_list() if rospy.get_param('rospy_initialized', False) else []
    ...
    def test_ros_node_communication(self):
        ...
        try:
            ...
            node_names = rospy.get_node_names() if rospy.get_param('rospy_initialized', False) else []
