...
class DroneEvaluator:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.episode_timeout = config.get('episode_timeout', 300.0)      # 300s as per report
    ...
    def _evaluate_single_episode(self, policy_agent, environment, 
        ...
        while not done and step_count < int(self.episode_timeout * 20):  # 20Hz steps
            ...
            action, _ = policy_agent.select_action(observation, deterministic=True)  # Deterministic for evaluation
    ...
    def compare_with_baselines(self, baseline_methods: List[str] = None) -> Dict[str, Any]:
        ...
        if 'A*_Only' in self.evaluation_summaries and len(self.evaluation_summaries) > 1:
