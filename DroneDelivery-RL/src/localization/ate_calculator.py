...
class ATECalculator:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.alignment_method = config.get('alignment_method', 'sim3')  # 'sim3', 'se3', 'sim3_scale'
        self.max_time_difference = config.get('max_time_difference', 0.02)  # 20ms tolerance
        ...
        self.logger.info(f"Target ATE: EuRoC={self.target_ate_euroc*100:.1f}cm, TUM-VI={self.target_ate_tumvi*10:.0f}mm")
