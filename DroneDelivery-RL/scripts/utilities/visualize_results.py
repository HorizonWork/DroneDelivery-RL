...
class ResultsVisualizer:
    ...
    def _plot_training_curves(self, training_data: Dict[str, Any],
        ...
        if episode_rewards and energy_consumptions:
            ...
            norm_energy = 1 - (np.array(energy_consumptions) / max(energy_consumptions)) if energy_consumptions else []
    ...
    def _plot_performance_comparison(self, evaluation_data: Dict[str, Any],
        ...
        for method in methods:
            ...
            energy_score = max(0, 100 - (data['energy'] / 35))
            time_score = max(0, 100 - (data['time'] / 1.2))
            collision_score = max(0, 100 - data['collisions']  2.5)
    ...
    def _plot_target_achievements(self, evaluation_data: Dict[str, Any],
        ...
        targets = {
            ...
            'ATE Error\n5cm': {
                'current': performance_metrics.get('mean_ate', 0)  100,
                'target': 5.0,
