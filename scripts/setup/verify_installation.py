...
class InstallationVerifier:
    ...
    def _test_python_environment(self) - bool:
        ...
        if hasattr(sys, "real_prefix") or (
            ...
            print(
                f"   Virtual environment active: {os.environ.get('CONDA_DEFAULT_ENV', 'venv')}"
            )
        else:
    ...
    def _test_ml_packages(self) - bool:
        ...
        ml_packages = ["torch", "gymnasium", "pybullet", "tensorboard", "wandb"]
    ...
    def _test_configuration_files(self) - bool:
        ...
        config_files = ["config/main_config.yaml", "config/evaluation_config.yaml"]
    ...
    def _print_verification_summary(self, all_passed: bool):
        ...
        if all_passed:
            ...
            print(
                "3. python scripts/evaluation/evaluate_model.py --model models/checkpoints/ppo_final.pt"
            )
        else:
